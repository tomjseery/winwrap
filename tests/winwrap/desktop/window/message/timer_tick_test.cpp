...
struct TickingWindow : winwrap::Window<TickingWindow> {
    static constexpr const wchar_t* window_class_name = L"WinwrapTimerTickTest";
...
struct QuietWindow : winwrap::Window<QuietWindow> {
    static constexpr const wchar_t* window_class_name = L"WinwrapTimerTickQuietTest";
};
