...
void create_plain_window(PlainWindow& window, DWORD ex_style = 0) {
    REQUIRE(window.create({.style = WS_OVERLAPPEDWINDOW,
                           .ex_style = ex_style,
                           .x = off_screen,
                           .y = off_screen,
                           .width = 320,
...
TEST_CASE("style and ex_style report the window's style bits") {
    PlainWindow window;
    create_plain_window(window, WS_EX_TOOLWINDOW);
