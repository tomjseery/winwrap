...
#include "winwrap/user/desktop/window/base_window.hpp"
#include "winwrap/user/desktop/window/creation_result.hpp"
#include "winwrap/user/desktop/window/message/focus_aware.hpp"
#include "winwrap/user/desktop/window/message/keyboard_input.hpp"
#include "winwrap/user/desktop/window/message/lifecycle.hpp"
#include "winwrap/user/desktop/window/message/message_router.hpp"
#include "winwrap/user/desktop/window/message/mouse_input.hpp"
#include "winwrap/user/desktop/window/message/paintable.hpp"
#include "winwrap/user/desktop/window/message/size_change.hpp"
#include "winwrap/user/desktop/window/message/timer_tick.hpp"
#include "winwrap/user/desktop/window/message/window_command.hpp"
#include "winwrap/user/desktop/window/native_window.hpp"
#include "winwrap/user/desktop/window/notification/command/reflection.hpp"
...
/// `class MyWindow : public winwrap::user::Window<MyWindow>`: the base owns class
...
/// message behaviors in <winwrap/user/desktop/window/message/>:
///
