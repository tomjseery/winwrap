...
/// Derive as `class Button : public winwrap::user::Control<Button, notification::Click>`: the base
...
///
///   - **Input hooks** from <winwrap/user/desktop/window/message/> that every control gets --
