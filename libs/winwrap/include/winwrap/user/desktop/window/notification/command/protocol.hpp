...
/// message handled; otherwise pass. (See the mixins in <winwrap/user/desktop/window/notification/command/>.)
...
std::optional<LRESULT> handle_command(UINT msg, WPARAM wparam, WORD code,
