...
/// are not commands the window handles directly -- notification::Reflection bounces those home.
/// CommandMessages and notification::Reflection split `WM_COMMAND` between them by lparam (== 0 here,
